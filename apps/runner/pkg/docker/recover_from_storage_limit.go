...
func (d *DockerClient) RecoverFromStorageLimit(ctx context.Context, sandboxId string, originalStorageQuota float64, registry *dto.RegistryDTO, volumes []dto.VolumeDTO) error {
	...
	return d.ContainerDiskResize(ctx, sandboxId, newStorageQuota, 0, 0, "recovery", registry, volumes)
}
